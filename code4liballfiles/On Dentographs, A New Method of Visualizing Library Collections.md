---
title: "On Dentographs, A New Method of Visualizing Library Collections"
source: "https://journal.code4lib.org/articles/6300"
author:
  - "[[The Code4Lib Journal]]"
published: 2012-02-03
created: 2025-01-10
description: "A dentograph is a visualization of a library's collection built on the idea that a classification scheme is a mathematical function mapping one set of things (books or the universe of knowledge) onto another (a set of numbers and letters). Dentographs can visualize aspects of just one collection or can be used to compare two [...]"
tags:
  - "clippings"
---
...
[![Checkerboard dentographs of the Toronto and San Francisco Public Libraries](https://journal.code4lib.org/media/issue16/denton/comparison-tpl-to-sfpl.png "Checkerboard dentographs of the Toronto and San Francisco Public Libraries")](https://journal.code4lib.org/media/issue16/denton/comparison-tpl-to-sfpl-large.png)
...
[![Comparison of mountain dentographs of University of Toronto branches Robarts and Gerstein](https://journal.code4lib.org/media/issue16/denton/utoronto-branches-smaller.png "Mountain dentographs of University of Toronto branches Robarts and Gerstein")](https://journal.code4lib.org/media/issue16/denton/utoronto-branches.png)
...
The most basic Dewey dentograph shows the collection broken down to the tens: the ten hundreds are broken down into ten tens each, making a 10×10 grid with 100 squares. I call this a one-by-one Dewey checkerboard dentograph, because it uses one number of importance on each side of the grid.
...
[![Raw, unadorned Toronto Public Library one-by-one checkerboard dentograph](https://journal.code4lib.org/media/issue16/denton/tpl-one-by-one-smaller.png "Raw, unadorned Toronto Public Library one-by-one checkerboard dentograph")](https://journal.code4lib.org/media/issue16/denton/tpl-one-by-one.png)
...
[![Toronto Public Library one-by-one checkerboard dentograph](https://journal.code4lib.org/media/issue16/denton/tpl-one-by-one-dentograph.png "Toronto Public Library one-by-one checkerboard dentograph")](https://journal.code4lib.org/media/issue16/denton/tpl-one-by-one-dentograph-large.png)
...
The next step is to go further into the numbers. Let’s make a one-by-two checkerboard dentograph, again with the hundreds on the x-axis but now tens and ones on the y-axis. This will be a 10×100 matrix. The process is the same as above, but [`make-one-by-two-data.rb`](https://github.com/wdenton/c4lj-dentographs/blob/master/make-one-by-two-data.rb) prepares the data:
...
[![Toronto Public Library one-by-two checkerboard dentograph "Toronto Public Library one-by-two checkerboard dentograph"](https://journal.code4lib.org/media/issue16/denton/tpl-one-by-two-dentograph.png)](https://journal.code4lib.org/media/issue16/denton/tpl-one-by-two-dentograph-large.png)
...
Going one more level into the Dewey numbers, to make a two-by-two dentograph of a 100×100 matrix, is far more interesting. [`make-two-by-two-data.rb`](https://github.com/wdenton/c4lj-dentographs/blob/master/make-two-by-two-data.rb) will generate the file of pairs of numbers we need:
...
[![Toronto Public Library two-by-two checkerboard dentograph](https://journal.code4lib.org/media/issue16/denton/tpl-two-by-two-dentograph.png "Toronto Public Library two-by-two checkerboard dentograph")](https://journal.code4lib.org/media/issue16/denton/tpl-two-by-two-dentograph-large.png)
...
[![Comparison of Toronto Public Library and San Francisco Public Library one-by-one checkerboard dentographs](https://journal.code4lib.org/media/issue16/denton/comparison-tpl-to-sfpl.png "Comparison of Toronto Public Library and San Francisco Public Library one-by-one checkerboard dentographs")](https://journal.code4lib.org/media/issue16/denton/comparison-tpl-to-sfpl-large.png)

**Figure 7.** Comparison of Toronto Public Library and San Francisco Public Library one-by-one checkerboard dentographs
...
[![Unlabelled mountain dentograph of the University of Toronto](https://journal.code4lib.org/media/issue16/denton/utoronto-mountain-unlabelled.png "Unlabelled mountain dentograph of the University of Toronto")](https://journal.code4lib.org/media/issue16/denton/utoronto-mountain-unlabelled-large.png)

**Figure 8.** Unlabelled mountain dentograph of the University of Toronto
...
**Figure 9.** University of Toronto’s Robarts and Gerstein branches compared
...
[![Mountain dentographs of University of Toronto, York University and University of Prince Edward Island](https://journal.code4lib.org/media/issue16/denton/mountain-comparison-smaller.png "Mountain dentographs of University of Toronto, York University and University of Prince Edward Island")](https://journal.code4lib.org/media/issue16/denton/mountain-comparison.png)
...
William Denton <[wdenton@yorku.ca](https://journal.code4lib.org/articles/)\> is Web Librarian at York University in Toronto, Canada. He has a B.Sc in Mathematics and an MISt from the University of Toronto. His web site is [Miskatonic University Press](http://www.miskatonic.org/).